...
int main() {
    ...
    cout << "\nКол-во элементов групп: ";
    for (int i = 0; i < groups; ++i) {
        cout << arr1[i] << " ";
    }
    cout << "\nКол-во нечётных групп: " << q;

    // --

    // ---- создание массива из групп с нечётным кол-вом символов
    ...
    cout << "Массив нечётного кол-ва групп:\n";
    for (int i = 0; i < q; ++i) {
        for (int j = 0; j < max_arr; ++j) {
