//Лабораторная 2, задача 7.2 Выполнена: 
    ...
    if (a == 0) {
        ...
        if (D1 < 0) {
            ...
            if (D2 > 0 && D3 > 0) { // + + 
                ...
                cout << "Корни уравнения:\n" << x2_1 << endl << x2_2 << endl << x3_1 << endl << x3_2 << endl;
            }
            else if (D2 > 0 && D3 < 0) { // + -
                x2_1 = (-b2 + sqrt(D2)) / (2 * a2);
                x2_2 = (-b2 - sqrt(D2)) / (2 * a2);
